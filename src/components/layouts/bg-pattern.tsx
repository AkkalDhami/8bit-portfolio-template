...
export function BgPattern() {
  return (
    <>
      ...
      <div className="pointer-events-none fixed inset-0 -z-10 flex items-center justify-center text-5xl font-bold tracking-widest text-neutral-200 uppercase sm:text-8xl dark:text-neutral-900">
