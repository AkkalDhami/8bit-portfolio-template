      ...
      <div className={cn("grid grid-cols-1 gap-4 md:grid-cols-2", className)}>
        {socialLinks.map(social => (
          <motion.a
            ...
            />
            <div className="flex w-full space-y-0.5 flex-col items-start">
              ...
              <p className="text-muted-foreground sm:block hidden text-xs sm:text-sm">{social.username}</p>
              <p className="text-muted-foreground sm:hidden block text-xs sm:text-sm">{
                social.username.length > 18 ? social.username.slice(0, 18) + '..' : social.username
              }</p>
            </div>
          </motion.a>
        ))}
